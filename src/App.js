    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-lg-2">
          ...
          <img id="ret_zona" width="7%" src="imagens/mapa/zona.svg" alt="zona" />
          ...
          <a href="#artistas" className = "artistas"> Artistas</a>
          <img id="ret_artista" width="7%" src="imagens/mapa/artista.svg"  alt="artista" />
